...
namespace Waedist.Controllers
{
    public class HomesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Homeid,Companylogo,Tittlepic,Tittle,Companyname,Headertext,Asidertittle,Description,Companyemail,Address,Companyphone")] Home home)
        {
            if (id != home.Homeid)
            {
                return NotFound();
